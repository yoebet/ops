...
CREATE MATERIALIZED VIEW tm.t_fp_5m_p1
...
CREATE MATERIALIZED VIEW tm.t_fp_5m_p2
    WITH (timescaledb.continuous)
AS
SELECT time_bucket('5m'::interval, "time")  as time,
       symbol,
...
CREATE MATERIALIZED VIEW tm.t_fp_5m_p4
    WITH (timescaledb.continuous)
AS
SELECT time_bucket('5m'::interval, "time")  as time,
       symbol,
...
CREATE MATERIALIZED VIEW tm.t_fp_5m_p8
    WITH (timescaledb.continuous)
AS
SELECT time_bucket('5m'::interval, "time")  as time,
       symbol,
...
CREATE MATERIALIZED VIEW tm.t_fp_5m_p16
    WITH (timescaledb.continuous)
AS
SELECT time_bucket('5m'::interval, "time")  as time,
       symbol,
...
CREATE MATERIALIZED VIEW tm.t_fp_5m_p32
    WITH (timescaledb.continuous)
AS
SELECT time_bucket('5m'::interval, "time")  as time,
       symbol,
...
CREATE MATERIALIZED VIEW tm.t_fp_5m_p64
    WITH (timescaledb.continuous)
AS
SELECT time_bucket('5m'::interval, "time")  as time,
       symbol,
...
CREATE MATERIALIZED VIEW tm.t_fp_5m_p128
    WITH (timescaledb.continuous)
AS
SELECT time_bucket('5m'::interval, "time")  as time,
       symbol,
