...
CREATE MATERIALIZED VIEW tm.t_fp_1h_p1
...
CREATE MATERIALIZED VIEW tm.t_fp_1h_p4
    WITH (timescaledb.continuous)
AS
SELECT time_bucket('1h'::interval, "time")  as time,
       symbol,
...
CREATE MATERIALIZED VIEW tm.t_fp_1h_p8
    WITH (timescaledb.continuous)
AS
SELECT time_bucket('1h'::interval, "time")  as time,
       symbol,
...
CREATE MATERIALIZED VIEW tm.t_fp_1h_p16
    WITH (timescaledb.continuous)
AS
SELECT time_bucket('1h'::interval, "time")  as time,
       symbol,
...
CREATE MATERIALIZED VIEW tm.t_fp_1h_p32
    WITH (timescaledb.continuous)
AS
SELECT time_bucket('1h'::interval, "time")  as time,
       symbol,
...
CREATE MATERIALIZED VIEW tm.t_fp_1h_p64
    WITH (timescaledb.continuous)
AS
SELECT time_bucket('1h'::interval, "time")  as time,
       symbol,
...
CREATE MATERIALIZED VIEW tm.t_fp_1h_p128
    WITH (timescaledb.continuous)
AS
SELECT time_bucket('1h'::interval, "time")  as time,
       symbol,
...
CREATE MATERIALIZED VIEW tm.t_fp_1h_p256
    WITH (timescaledb.continuous)
AS
SELECT time_bucket('1h'::interval, "time")  as time,
       symbol,
...
CREATE MATERIALIZED VIEW tm.t_fp_1h_p512
    WITH (timescaledb.continuous)
AS
SELECT time_bucket('1h'::interval, "time")  as time,
       symbol,
