...
CREATE MATERIALIZED VIEW tm.t_fp_5s_p1
...
CREATE MATERIALIZED VIEW tm.t_fp_5s_p2
    WITH (timescaledb.continuous)
AS
SELECT time_bucket('5s'::interval, "time")  as time,
       symbol,
...
CREATE MATERIALIZED VIEW tm.t_fp_5s_p4
    WITH (timescaledb.continuous)
AS
SELECT time_bucket('5s'::interval, "time")  as time,
       symbol,
...
CREATE MATERIALIZED VIEW tm.t_fp_5s_p8
    WITH (timescaledb.continuous)
AS
SELECT time_bucket('5s'::interval, "time")  as time,
       symbol,
...
CREATE MATERIALIZED VIEW tm.t_fp_5s_p16
    WITH (timescaledb.continuous)
AS
SELECT time_bucket('5s'::interval, "time")  as time,
       symbol,
